  ...
  return(
    <div className={`flex flex-row p-6 rounded-[20px] 
      ...
      <div className="flex-1 flex flex-col ml-3">
        <h4 className="font-poppinns font-semibold text-white text-[18px] leading-[23px] mb-1">
          {title}
        </h4>
        <p className="font-poppinns font-normal text-dimWhite text-[16px] leading-[24px] mb-1">{content}</p>
      </div>
    </div>
  );
}
